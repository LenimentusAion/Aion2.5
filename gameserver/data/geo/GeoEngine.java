  ...
  httpwww.gnu.orgcopyleftgpl.html
...
public class GeoEngine
{
    ...
    private MapInteger, GeoMap geoMaps = new HashMapInteger, GeoMap();
    ...
    GeoEngine()
    {
        ...
        {
            MapString, Spatial models = GeoWorldLoader.loadMeshs();
...
Hide details
Change log
r324 by ZeroSignal82 on Jun 20, 2011   Diff
GameServerDevOnly - Open Aion Integration
#5
Go to 	
